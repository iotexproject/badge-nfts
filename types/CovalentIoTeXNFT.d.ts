...
interface CovalentIoTeXNFTInterface extends ethers.utils.Interface {
  functions: {
...
export class CovalentIoTeXNFT extends BaseContract {
  ...
  interface: CovalentIoTeXNFTInterface;
