...
interface PebblePioneerNFTInterface extends ethers.utils.Interface {
  functions: {
...
export class PebblePioneerNFT extends BaseContract {
  ...
  interface: PebblePioneerNFTInterface;
