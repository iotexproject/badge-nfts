...
interface CartesiIdeaThonNFTInterface extends ethers.utils.Interface {
  functions: {
...
export class CartesiIdeaThonNFT extends BaseContract {
  ...
  interface: CartesiIdeaThonNFTInterface;
